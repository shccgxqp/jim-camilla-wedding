...
const FRAME_ORDER = ["frame05", "frame04", "frame03", "frame02", "frame01"];
  ...
  return (
    <button
      ...
      style={{
        ...
        borderRadius: "50%",
        cursor: "pointer",
        background: "rgba(20,12,7,0.52)",
        backdropFilter: "blur(6px)",
        border: "1.5px solid #BD9A4E",
        color: "#E4C97E",
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
        boxShadow:
          "0 8px 22px rgba(0,0,0,0.5), inset 0 0 0 1px rgba(228,201,126,0.1)",
        flexShrink: 0,
      }}
    >
      <svg
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    transition:
                      "transform 380ms cubic-bezier(.5,0,.2,1), opacity 320ms ease",
                    filter: isCenter
